<x-hockeyclub-layout>
    <p>Klik op de volgende link om uw e-mailadres te verifiëren:</p>

    <a href="{{ route('verification.verify', ['id' => $user->id, 'hash' => $user->verification_token]) }}">Verify Email Address</a>
