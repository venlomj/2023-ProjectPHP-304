...
class Type extends Model
{
    ...
    protected function cover() : Attribute
    {
        return Attribute::make(
            get: function ($value, $attributes) {
                if ( !empty($attributes) && Storage::disk('public')->exists('products/' . $attributes['cover'])) {
                    return Storage::url('products/' . $attributes['cover']);
                }
                else {
                    return Storage::url('products/geen-afbeelding.jpg');
                }
            });
    ...
    {
        return $this->belongsTo(TypePrice::class)->withDefault();
    }
}
